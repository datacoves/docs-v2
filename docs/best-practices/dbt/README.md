...
To assist with future change & onboarding, each model should contain only what it must to get to the next stage of complexity. The [dbt project guidelines](./dbt-guidelines) assist with decision-making to keep the environment clean.
