...
1. [Setting up your Datacoves Account with our team](/docs/getting-started/create-account)
2. [Configure Airflow](/docs/getting-started/Admin/configure-airflow)
3. [Creating Airflow Dags](/docs/getting-started/Admin/creating-airflow-dags)
4. [User Management](/docs/getting-started/Admin/user-management)
