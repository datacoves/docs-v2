...
description: "Schedule cleanup of the Airflow metadata database in Datacoves using the datacoves_airflow_db_cleanup decorator (Airflow 3) or airflow db clean (Airflow 2)."
sidebar_position: 4
---
