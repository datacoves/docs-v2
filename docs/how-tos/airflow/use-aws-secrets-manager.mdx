...
Secrets backends are configured per project. See [configure your AWS Secrets Manager](../datacoves/how_to_projects/how_to_configure_aws_secrets_manager) for details.
