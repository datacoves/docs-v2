...
Creating a [Datacoves Secret](/docs/how-tos/datacoves/how_to_secrets) requires some key fields to be filled out:
...
**Note:** For Azure OpenAI, see the dedicated Azure OpenAI tab for specific setup instructions.
...
<TabItem value="openrouter" label="Open Router">
