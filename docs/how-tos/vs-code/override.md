...
Once you have [set up your Visual Studio Code](/docs/how-tos/vs-code/initial) environment, you have the possibility to override certain settings we provide by default. This is done in your Workspace settings.
