...
Lineage Panel has 3 configurable settings. As with any VSCode setting, these can be [overridden](/how-tos/vs-code/override) in the `settings.json` file located in `workspace/.vscode/settings.json`:
