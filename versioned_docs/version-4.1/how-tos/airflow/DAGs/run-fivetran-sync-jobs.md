...
In Addition to triggering Airbyte loads jobs [run Airbyte sync jobs](/how-tos/airflow/DAGs/run-airbyte-sync-jobs) you can also trigger Fivetran jobs from your Airflow DAG.
